...
export const translations = {
  en: {
    ...
    about: {
      tag:   '01. about',
      title: 'About Me',
      p1: 'Passionate Data Analyst with hands-on experience transforming complex, multi-source datasets into clear, actionable business intelligence.',
      p2: 'I combine SQL and Python to handle every stage of the data pipeline — from raw data ingestion and cleaning to exploratory analysis, statistical modelling, and storytelling through visualization. My projects cover the full spectrum: building a structured data warehouse by integrating CRM and ERP sources, and performing deep e-commerce analytics on 1.5 million+ transaction records using segmentation algorithms (RFM + K-Means).',
      p3: 'I enjoy finding the patterns hidden in data and translating them into decisions that matter — whether that\'s spotting seasonal revenue trends, profiling high-value customer clusters, or optimising logistics accuracy.',
  ...
  it: {
    ...
    about: {
      tag:   '01. chi sono',
      title: 'Chi sono',
      p1: 'Data Analyst appassionata, con esperienza concreta nella trasformazione di dataset complessi e multi-sorgente in intelligenza di business chiara e azionabile.',
      p2: 'Combino SQL e Python per gestire ogni fase della pipeline dati — dall\'ingestione e pulizia dei dati all\'analisi esplorativa, alla modellazione statistica e alla narrazione attraverso la visualizzazione. I miei progetti spaziano dalla costruzione di un data warehouse strutturato, integrando fonti CRM ed ERP, all\'analisi approfondita di un e-commerce con oltre 1,5 milioni di record transazionali mediante algoritmi di segmentazione (RFM + K-Means).',
